...
import 'package:car_m/ui/screens/profile/widgets/post/post_widget_profile_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import '../../../../../constants/app_styles.dart';

class SinglePostWidgetProfile extends StatefulWidget {
  const SinglePostWidgetProfile({Key? key,required this.id}) : super(key: key);
  final String id;
  @override
  State<SinglePostWidgetProfile> createState() => _SinglePostWidgetProfileState();
}

class _SinglePostWidgetProfileState extends State<SinglePostWidgetProfile> {
  @override
  Widget build(BuildContext context) {
    final model = SinglePostWidgetProfileModel(id: widget.id);
...
class _SinglePostWidgetBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = NotifierProvider.watch<SinglePostWidgetProfileModel>(context);
