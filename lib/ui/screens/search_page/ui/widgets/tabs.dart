import 'package:car_m/ui/screens/search_page/ui/widgets/clubs/ui/clubs_screen.dart';
import 'package:car_m/ui/screens/search_page/ui/widgets/profile/others_profile.dart';
...
class _TabBarForSearchState extends State<TabBarForSearch>
        ...
        child: Container(
          child: TabBarView(
            ...
            children: [
              ...
              Tab(
                child: Center(child: Text('${AppLocalizations.of(context)?.empty}')),
              ),
            ],
          ),
        ),
