...
//
//     final clubsDto = clubsDtoFromJson(jsonString);

import 'dart:convert';

List<ClubsDto> clubsDtoFromJson(String str) => List<ClubsDto>.from(json.decode(str).map((x) => ClubsDto.fromJson(x)));

String clubsDtoToJson(List<ClubsDto> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ClubsDto {
  ...
  factory ClubsDto.fromJson(Map<String, dynamic> json) => ClubsDto(
    id: json["id"],
    brand: json["brand"],
